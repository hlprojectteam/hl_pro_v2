...
public class TrafficAccidentController extends BaseController{
	 ...
	 * @Date 2019年3月5日
	 */
	@RequestMapping(value="/trafficAccident_export")
	public void export(HttpServletRequest request, HttpServletResponse response, TrafficAccidentVo trafficAccidentVo){
		//excel文件名
		String fileName = "交通事故汇总";

		//获取excle文档对象
		HSSFWorkbook wb = this.trafficAccidentServiceImpl.export(trafficAccidentVo);
