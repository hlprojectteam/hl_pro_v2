...
public class RescueWorkController extends BaseController{
	 ...
	 * @Date 2019年3月5日
	 */
	@RequestMapping(value="/rescueWork_export")
	public void export(HttpServletRequest request, HttpServletResponse response, RescueWorkVo rescueWorkVo){
		//excel文件名
		String fileName = "拯救作业汇总";

		//获取excle文档对象
		HSSFWorkbook wb = this.rescueWorkServiceImpl.export(rescueWorkVo);
