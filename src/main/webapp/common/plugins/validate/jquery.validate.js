...
$.extend($.validator, {
	...
	classRuleSettings: {
		...
		num2: {num2: true},
		idcard: {idcard: true},
		numbersenglish: {numbersenglish: true},
		english: {english: true},
		englishbig: {englishbig: true},
		englishsmall: {englishsmall: true},
	},
...
//			return this.optional(element) || /^0\d{2,3}-?\d{7,8}$/.test(value);
			//固定电话 区号+号码+分机 区号3-4位（可以不写） 电话7-8位 分机号3-4位 中间用“-”连接 如 020-12345678-123，84881234，8488123，84881234-1234
			return this.optional(element) || /(([0-9]{3,4}-)?[0-9]{7,8})(-(\d{3,4}))?$/.test(value);
		},
		//固话，手机号码
		//		(1)电话号码由数字、"("、")"和"-"构成 
		//		(2)电话号码为3到8位 
		...
		//残疾人证
		discard: function( value, element ) {
			var reg='';
			if(value.length==20){
				reg = /^(\d{6})(\d{4})(\d{2})(\d{2})(\d{3})([0-9]|X)([1-7])([1-4])$/;
			}else{
				reg = /^(\d{6})(\d{4})(\d{2})(\d{2})(\d{3})([0-9]|X)([1-7])([1-4])B([1-9])$/;
			}
			return this.optional(element) || reg.test(value);
		},
		//只能输入英文数字
		numbersenglish: function( value, element ) {
		...
		//只能是大写英文
		englishbig: function( value, element ) {
			return this.optional(element) || /^[A-Z_]+$/.test(value);
		},
		//只能是小写英文
		englishsmall: function( value, element ) {
			return this.optional(element) || /^[a-z_]+$/.test(value);
		},
