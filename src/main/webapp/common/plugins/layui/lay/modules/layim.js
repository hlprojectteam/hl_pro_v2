...
;layui.define(["layer", "laytpl", "upload"],function(i) {
    ...
    w = function(i, a, n) {
        ...
        e.ajax({
            ...
            cache: !1,
            success: function(i) {
            	groupCreateId = i.groupCreateId;//群组创建人
    ...
    T = function(i) {
        return t.open({
            type: 1,
            area: ["260px", "520px"],
            skin: "layui-layer-molv layui-layim",
            title: "&#8203;",
            offset: "rb",
            id: "layui-layim",
            shade: !1,
    ...
    I = function() {
        ...
        function(a) {
            ...
            n.hasClass("layim-null") || (t.tips(l, this, {
                ...
                shift: 5,
                fix: !0,
                skin: "layui-layer-molv layui-layim-contextmenu",
                success: function(i) {
                    var a = function(i) {
                        B(i)
                    };
    ...
    j = function(i) {
        ...
        t.open({
            ...
            skin: "layui-layer-molv layui-layim-min layui-layim-close",
            shade: !1,
            closeBtn: !1,
            shift: 2,
            offset: "rb",
            content: '<img src="' + (C.mine.avatar || layui.cache.dir + "css/pc/layim/skin/logo.jpg") + '"><span>' + (i || C.base.title || "即时通讯") + "</span>",
    ...
    L = function(i) {
        ...
        var d = b = t.open({
            type: 1,
            area: ["600px", "520px"],
            skin: "layui-layer-molv layui-layim-chat",
            id: "layui-layim-chat",
            title: "&#8203;",
            shade: !1,
            moveType: 1,
    ...
    M = function(i) {
        ...
        t.open({
            ...
            title: !1,
            id: "layui-layim-min",
            skin: "layui-layer-molv layui-layim-min",
            shade: !1,
            closeBtn: !1,
            shift: a.shift || 2,
            offset: "b",
    ...
    U = {
        ...
        skin: function() {
            t.open({
                ...
                shade: !1,
                area: "300px",
                skin: "layui-layer-molv layui-layer-border",
                id: "layui-layim-skin",
                zIndex: 66666666,
                content: n(y).render({
                    skin: C.base.skin
...
//            })
        ...
        groupMembers: function(i, a) {
            ...
            i.data("down") ? l() : (n.html("&#xe619;"), i.data("down", !0), U.groupMembers.index = t.tips('<ul class="layim-members-list"></ul>', i, {
                ...
                shift: 5,
                fix: !0,
                skin: "layui-layer-molv layui-layim-members",
                success: function(a) {
...
//                        	if(i==0){
//                        		if(currentLoginId==groupCreateId)//当前登录人=群组创建人
//                        			l+= '<li><a href="javaScript:void(0)" layim-event="on_addUser"><img src="/common/plugins/layui/css/modules/layim/user_head.png"></a><p>添加人员</p></li>'
//                        	}
                        	if(currentLoginId==groupCreateId){//当前登录人=群组创建人
                        		if(groupCreateId==a.id)//群组创建人 不能删除自己
                        			l += '<li><a><img src="' + a.avatar + '"/></a><p>' + a.username + "</p></li>"     
                        		else	
                        			l += '<li onmouseover="on_memberShowDel(this)" onmouseout="on_memberShowOut(this)"><a><img src="' + a.avatar + '"/><span class="badge" style="z-index: 99;position:absolute;right:-10px;top;-10px;display:none;" onclick="on_delMember(this,\''+a.id+'\',\''+groupId+'\')">X</span></a><p>' + a.username + "</p></li>"
                        	}else{
                        		l += '<li><a><img src="' + a.avatar + '"/></a><p>' + a.username + "</p></li>"                        		
                        	}
                        }),
        ...
        on_addUser: function(i) {//群组增加新人
//        	i.parent().parent().append('<li><a><img src="/common/plugins/layui/images/avatar/a11.jpg"></a><p>我问问</p></li>');
        },
        send: function() {
            A()
        },
        ...
        face: function(i, a) {
            ...
            U.face.index = t.tips(n, i, {
                ...
                time: 0,
                fix: !0,
                skin: "layui-layer-molv layui-layim-face",
                success: function(i) {
...
//                    0 == i.code ? (i.data = i.data || {}, "images" === a ? F(n.textarea[0], "img[" + (i.data.src || "") + "]") : "file" === a && F(n.textarea[0], "file(" + (i.data.src || "") + ")[" + (i.data.name || "下载文件") + "]")) : t.msg(i.msg || "上传失败")
        ...
        chatLog: function(i) {
            ...
            return C.base.chatLog ? (t.close(U.chatLog.index), U.chatLog.index = t.open({
              ...
              shade: !1,
              offset: "rb",
              skin: "layui-layer-molv",//layui-layer-molv layui-box
              shift: 2,
