    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        if (this.options.queryParamsType === 'limit') {
            params = {
                ...
                sortOrder: params.sortOrder  //实用sortOrder 实用order，就会报错，就算自己写一个请求数据 只要有order就会出错
            };
            if (this.options.pagination) {
            	/* 程序原来的页数返回
            	...
            	/* 修改后的页数返回 */
            	params.rows = this.options.pageSize;  //每页大小
            	params.page = this.options.pageNumber; //页数
