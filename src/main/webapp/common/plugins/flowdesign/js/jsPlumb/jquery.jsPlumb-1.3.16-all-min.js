            ...
            _doOne = function(bO) {
                ...
                bK = function() {
                    ...
                    if (bW) {
                        ...
                        var sourceId = bY.sourceId.replace("window","");
                        var targetId = b2.elementId.replace("window","");
                        var bX = br.connect({
                        	label:"<span convert_id='"+uuid()+"' id='"+sourceId+"_"+targetId+"'  convert_code='' style='font-size:22px;color:#000000' actor_ids='' actor_names='' role_ids='' role_names='' orgframe_ids='' orgframe_names='' order='1'>连接线<span>",
                            source: bQ,
                            target: b2,
                            scope: b1,
                        ...
                        //修改流向指向终点位置
                        var process_to = $("#window"+sourceId).attr("process_to");
                        if(process_to.length>0)
                        	process_to +=","+targetId;
                        else
                        	process_to = targetId
                        $("#window"+sourceId).attr("process_to",process_to);	
                        bX.bind("contextmenu", function(connection,originalEvent) {//右键
