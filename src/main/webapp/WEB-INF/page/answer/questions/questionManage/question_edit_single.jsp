	...
	if(num!=1){
		...
		$.ajax({
			...
			success : function(data){
				if(data.result){
					autoMsg("保存成功！",1);
					parent.frames[winName].$("#gridSingle").bootstrapTable("refresh",{url:"/answer/question_load?type=1&questionManageId=${questionManageId}"});//加载树下的列表
