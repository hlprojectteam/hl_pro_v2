...
<ul class="nav nav-tabs">
    ...
    <li class=""><a data-toggle="tab" href="#other">其他信息</a></li>
</ul>
<%-- 基础信息 --%>
<div id="base" class="tab-pane active">
	...
	<input type="hidden" id="type" name="type" value="${userVo.type}"/><%-- 用户类型 --%>
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
      			<input type="text" class="form-control" id="loginName" name="loginName" value="${userVo.loginName }" autocomplete="off" data-rule-required="true" data-rule-numbersEnglish="true" data-rule-rangelength="[1,30]" data-rule-remote="/urms/user_checkUserLoginName?id=${userVo.id}" data-msg-remote="登录名称已经存在，请重新输入"/>
   			</div>
...
<div class="ibox-content">
	<div class="form-group">
	    ...
	    <div class="col-sm-4">
	      	<input type="password" class="form-control" id="password" name="password" value="${userVo.password }" autocomplete="off" data-rule-required="true" data-rule-minlength="6" data-rule-maxlength="30" data-msg-required="密码不能为空" data-msg-minlength="至少设置6位密码"/>
	    </div>
	</div>   
	<div class="form-group">    
	    <label class="col-sm-2 control-label"><span style="color: red">*</span>确认密码</label>
	    <div class="col-sm-4">
	      	<input type="password" class="form-control" id="password2" name="" value="${userVo.password }" autocomplete="off" data-rule-equalTo="#password" data-rule-minlength="6" data-rule-maxlength="30" data-msg-equalTo="两次密码不一致"/>
	    </div>
	</div>
</div>	
</div>
...
<!-- 	<div class="form-group">     -->
<!-- 	    <label class="col-sm-2 control-label"><span style="color: red">*</span>所属子系统</label> -->
<!--     	<div class="col-sm-4"> -->
