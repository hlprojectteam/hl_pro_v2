...
var id = '${id}';//回填id
var pname = '${name}';//回填pname
var selectNum = '${selectNum}';//单选还是多选
var showUserName = '${showUserName}';//显示名字
var zTreeObj;
...
function on_sure(){
	...
	parent.frames[winName].$("#"+pname).val(names.substring(0,names.length-1));
...
function reSelectUser(){
	...
	var names =parent.frames[winName].$("#"+pname).val();
	if(ids!=null&&ids!=""){
		var idz = ids.split(",");
