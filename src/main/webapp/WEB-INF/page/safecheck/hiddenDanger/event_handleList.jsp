...
<script type="text/javascript"> 
    ...
    function pageInit() {
        ...
        $.ajax({
            ...
            url : '/safecheck/hiddenDanger/event_getHandleBaseCount',
    ...
    function loadGrid() {
        $("#grid").bootstrapTable({
            url: "/safecheck/hiddenDanger/event_loadHandleList",
            dataType:"json",
            method:"post",
            ...
            columns: [{checkbox:true,width: "3%"},
                      ...
                      {title: "隐患标题", field: "eventTitle",align: "center",width: "21%",formatter:function(value,row,index){
                      ...
                      /* {title: "隐患类型", field: "eventType",align: "center",width: "6%",formatter:function(value,row,index){
                      ...
                      {title: "离开时间", field: "epNowNodeLeavleTime",align:"center",width: "13%"},
    ...
    function td_click(id,epNowNode,epDealState) {
        parent.layer.open({
            ...
            area: ["100%", "100%"],
            content: "/safecheck/hiddenDanger/event_handleDetail?id="+id+"&epNowNode="+epNowNode+"&epDealState="+epDealState
          });
    }
</script>
</body>
