 ...
 // 初始化页面参数(各种隐患类型的待办隐患数量)
    function pageInit() {
        ...
        $.ajax({
            ...
            url : '/safecheck/hiddenDanger/event_getFinishBaseCount',
    ...
    function loadGrid() {
        $("#grid").bootstrapTable({
            url: "/safecheck/hiddenDanger/event_loadFinishList",
            dataType:"json",
            method:"post",
            ...
            columns: [{checkbox:true,width: "3%"},
                      ...
                      /*                办结这里还剩 8% 的空间
                      {title: "隐患编码",field: "eventCode",align: "center",width: "8%",formatter:function(value,row,index){
                      ...
                      {title: "总用时", field: "totalTime",align:"center",width: "12%",formatter:function(value,row,index){
                          var t1 = Date.parse(row.createTime);         //隐患上报时间
                          var t2 = Date.parse(row.epNowNodeArriveTime);        //当前节点(办结节点)的到达时间
                          return "<span style=\"color: 46BE8A\">"+ MillisecondToDate(t2-t1)+"</span>";
                          //return "<span style=\"color:red\">"+ MillisecondToDate(t2-t1)+"</span>";      //总用时
                      }},
    ...
    function td_click(id,epNowNode,epDealState) {
        parent.layer.open({
            ...
            area: ["100%", "100%"],
            content: "/safecheck/hiddenDanger/event_finishDetail?id="+id+"&epNowNode="+epNowNode+"&epDealState="+epDealState
          });
    }
</script>
</body>
