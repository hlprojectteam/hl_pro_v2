...
<div class="ibox-content">
    <form id="baseForm" method="post" class="form-horizontal" name="baseForm" action="" >
        ...
        <input type="hidden" id="sign" name="sign" value="fgldPage" />
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        reSelectUser();    //回调显示已选分管领导
    });

    //根据输入的用户名模糊查询相关分管领导信息
    function on_search(){
        loadUserList();
    }
    ...
    function on_sure(){
        ...
        parent.frames[winName].$("#nextPersonName_fgld").text(names.substring(0,names.indexOf(",")));
    ...
    function reSelectUser(){
        ...
        if(parent.frames[winName].$("#nextPersonName_fgld").text() != null && parent.frames[winName].$("#nextPersonName_fgld").text() != ""){
            names = parent.frames[winName].$("#nextPersonName_fgld").text();
        }
        if(ids!=null&&ids!=""){
            var idz = ids.split(",");
