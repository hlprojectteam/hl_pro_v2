		...
		<form id="baseForm" method="post" name="baseForm" class="form-horizontal" action="" >
			<c:if test="${not empty menuCode}">
				...
				<div class="row" style="margin-top: 10px;">
					<label class="col-sm-1 control-label">信息类型</label>
					<div class="col-sm-2">
						<opt:select dictKey="dc_infoType" classStyle="form-control" id="infoType" name="infoType" isDefSelect="true"/>
					</div>

					<label class="col-sm-1 control-label">通传方式</label>
					<div class="col-sm-2">
						<opt:select dictKey="dc_throughWay" classStyle="form-control" id="throughWay" name="throughWay" isDefSelect="true"/>
					</div>
...
<script type="text/javascript">
    ...
    function loadGrid() {
    	$("#grid").bootstrapTable({
    	    ...
    	    columns: [{checkbox:true},
		              ...
		              {title: "信息类型", field: "infoType",width: 140,align:"center"},
		              {title: "信息来源", field: "infoSource",width: 80,align:"center"},
		              {title: "通传方式", field: "throughWay",width: 160,align:"center"},
    ...
    function on_export(){
        ...
        if(star == null || star == "" || end == null || end == ""){
            ...
            window.location.href = URLStr + "export?dutyDateStart="+$("#dutyDateStart").val()+"&dutyDateEnd="+$("#dutyDateEnd").val()+"&keyword="+$("#keyword").val()+"&infoType="+$("#infoType").val()+"&throughWay="+$("#throughWay").val()
        }
    }
</script>
</body>
