...
<script type="text/javascript">
    ...
    function on_export(){
        ...
        if(star == null || star == "" || end == null || end == ""){
            ...
            window.location.href = URLStr + "export?dutyDateStart="+$("#dutyDateStart").val()+"&dutyDateEnd="+$("#dutyDateEnd").val() +"&keyword="+$("#keyword").val() +"&accidentType="+$("#accidentType").val()+"&accidentSite="+$("#accidentSite").val() +"&minorInjuryNum="+$("#minorInjuryNum").val()+"&seriousInjuryNum="+$("#seriousInjuryNum").val() +"&deathNum="+$("#deathNum").val()
        }
    }
</script>
</body>
