...
<script type="text/javascript">
    ...
    function loadGrid() {
    	$("#grid").bootstrapTable({
    	    ...
    	    columns: [{checkbox:true},
		              ...
		              {title: "上班次值班人员", field: "laseWatcher",width: 100,align:"center"},
    ...
    function on_export(){
        ...
        if(star == null || star == "" || end == null || end == ""){
            ...
            window.location.href = URLStr + "export?dutyDateStart="+$("#dutyDateStart").val()+"&dutyDateEnd="+$("#dutyDateEnd").val()+"&keyword="+$("#keyword").val()
        }
    }
</script>
</body>
