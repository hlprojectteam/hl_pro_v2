...
<script type="text/javascript">
    ...
    function loadGrid() {
    	$("#grid").bootstrapTable({
    	    ...
    	    columns: [{checkbox:true},
    	              ...
    	              {title: "开始时间", field: "startTime",width: 80,align:"center",formatter:function(value,row,index){
		           	  		return value.substr(11,5);
		              }},
    	              {title: "结束时间", field: "endTime",width: 80,align:"center",formatter:function(value,row,index){
		           	  		return value.substr(11,5);
		              }},
    	              {title: "交警到场时间", field: "jjdcTime",width: 80,align:"center",formatter:function(value,row,index){
		           	  		return value.substr(11,5);
		              }},
    ...
    function on_export(){
        ...
        if(star == null || star == "" || end == null || end == ""){
            ...
            window.location.href = URLStr + "export?dutyDateStart="+$("#dutyDateStart").val()+"&dutyDateEnd="+$("#dutyDateEnd").val()+"&receiptWay="+$("#receiptWay").val()+"&keyword="+$("#keyword").val()
        }
    }
</script>
</body>
