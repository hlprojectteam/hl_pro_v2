...
<script type="text/javascript">
    	...
    	$("#grid").bootstrapTable({
    	    ...
    	    columns: [{checkbox:true},
    	             ...
    	             /* {title: "标题", field: "title",width: 250,align:"center"}, */
    	              ...
    	              {title: "性别", field: "customerSex",width: 80,align:"center",formatter:function(value,row,index){
		           	  		return changeDataDictByKey("sex",value);
		              }},
		              {title: "车辆号牌", field: "plateNum",width: 80,align:"center"},
    	              {title: "联系电话", field: "customerPhone",width: 80,align:"center"},
    ...
    function on_export(){
        ...
        if(star == null || star == "" || end == null || end == ""){
            ...
            window.location.href = URLStr + "export?dutyDateStart="+$("#dutyDateStart").val()+"&dutyDateEnd="+$("#dutyDateEnd").val()+"&fbType="+$("#fbType").val()+"&keyword="+$("#keyword").val()
        }
    }
