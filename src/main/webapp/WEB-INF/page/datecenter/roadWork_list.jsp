	...
	<div class="row ibox-content" style="padding:5px 0 5px 0;">
		...
		<c:if test="${not empty menuCode}">
			...
			<div class="row" style="margin-top: 10px;">
				<label class="col-sm-1 control-label">施工内容</label>
				<div class="col-sm-2">
					<input type="text" class="form-control" id="constructionContent" name="constructionContent" value="" />
				</div>
				<label class="col-sm-1 control-label">整改措施</label>
				<div class="col-sm-2">
					<input type="text" class="form-control" id="rectificationMeasures" name="rectificationMeasures" value="" />
				</div>
    ...
    function loadGrid() {
    	$("#grid").bootstrapTable({
    	    ...
    	    columns: [{checkbox:true},
		              ...
		              {title: "位置属性", field: "positionAttributes",width: 80,align:"center"},
