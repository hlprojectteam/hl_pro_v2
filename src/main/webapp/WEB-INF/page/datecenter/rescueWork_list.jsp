		...
		<form id="baseForm" method="post" name="baseForm" class="form-horizontal" action="" >
			<c:if test="${not empty menuCode}">
				...
				<div class="row"  style="margin-top: 10px;">
					<label class="col-sm-1 control-label">拯救车牌</label>
					<div class="col-sm-2">
						<input type="text" class="form-control" id="rescuePlates" name="rescuePlates" value="" />
					</div>
					<label class="col-sm-1 control-label">故障车牌</label>
					<div class="col-sm-2">
						<input type="text" class="form-control" id="faultPlates" name="faultPlates" value="" />
					</div>
...
<script type="text/javascript">
    ...
    function on_export(){
        ...
        if(star == null || star == "" || end == null || end == ""){
            ...
            window.location.href = URLStr + "export?dutyDateStart="+$("#dutyDateStart").val()+"&dutyDateEnd="+$("#dutyDateEnd").val()+"&site="+$("#site").val()+"&rescuePlates="+$("#rescuePlates").val()+"&faultPlates="+$("#faultPlates").val()+"&keyword="+$("#keyword").val()
        }
    }
</script>
</body>
