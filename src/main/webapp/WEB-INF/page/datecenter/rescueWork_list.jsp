    ...
    function loadGrid() {
    	$("#grid").bootstrapTable({
    	    ...
    	    columns: [{checkbox:true},
    	              ...
    	              {title: "日期", field: "dutyDate",width: 400,align:"center",formatter:function(value,row,index){
    	              ...
    	              {title: "地点", field: "site",width: 80,align:"center"},
    	              {title: "故障车牌", field: "faultPlates",width: 80,align:"center"},
    	              {title: "车型", field: "carType",width: 80,align:"center",formatter:function(value,row,index){
    	              ...
    	              {title: "拯救车牌", field: "rescuePlates",width: 80,align:"center"},
