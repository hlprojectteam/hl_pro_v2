		...
		<form id="baseForm" method="post" name="baseForm" class="form-horizontal" action="" >
			<c:if test="${not empty menuCode}">
				...
				<div class="row" style="margin-top: 10px;">
					<label class="col-sm-1 control-label">事发地点</label>
					<div class="col-sm-2">
						<input type="text" class="form-control" id="scene" name="scene" value="" />
					</div>
...
<script type="text/javascript">
    ...
    function on_export(){
        ...
        if(star == null || star == "" || end == null || end == ""){
            ...
            window.location.href = URLStr + "export?dutyDateStart="+$("#dutyDateStart").val()+"&dutyDateEnd="+$("#dutyDateEnd").val()+"&receiptWay="+$("#receiptWay").val()+"&scene="+$("#scene").val()+"&keyword="+$("#keyword").val()
        }
    }
