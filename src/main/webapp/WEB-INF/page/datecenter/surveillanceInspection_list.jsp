		...
		<form id="baseForm" method="post" name="baseForm" class="form-horizontal" action="" >
			<c:if test="${not empty menuCode}">
				...
				<div class="row" style="margin-top: 10px;">
					...
					<div class="col-sm-2">
						<opt:select dictKey="dc_inspectionlocation" classStyle="form-control" id="inspectionlocation" name="inspectionlocation" isDefSelect="true"/>
					</div>
...
<script type="text/javascript">
    	...
    	$("#grid").bootstrapTable({
    	    ...
    	    columns: [{checkbox:true},
                    ...
                    {title: "故障设备", field: "failureEquipment",width: 80,align:"center",formatter:function(value,row,index){
    	              ...
    	              /*{title: "巡检情况描述", field: "inspectionDetails",width: 80,align:"center"},
    	              {title: "跟进措施", field: "followMeasure",width: 80,align:"center"},*/
    ...
    function on_export(){
        ...
        if(star == null || star == "" || end == null || end == ""){
            ...
            window.location.href = URLStr + "export?dutyDateStart="+$("#dutyDateStart").val()+"&dutyDateEnd="+$("#dutyDateEnd").val()+"&inspectionlocation="+$("#inspectionlocation").val()+"&keyword="+$("#keyword").val()
        }
    }
</script>
</body>
