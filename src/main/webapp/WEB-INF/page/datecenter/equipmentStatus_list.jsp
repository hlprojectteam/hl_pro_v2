    ...
    function loadGrid() {
        $("#grid").bootstrapTable({
            ...
            columns: [{checkbox:true},
                ...
                {title: "R1状态", field: "eqStatusR1",align:"center",formatter:function(value,row,index){
                        return changeDataDictByKey("dc_eqStatus",value);
                }},
                {title: "R2状态", field: "eqStatusR2",align:"center",formatter:function(value,row,index){
                        return changeDataDictByKey("dc_eqStatus",value);
                }},
                {title: "E1状态", field: "eqStatusE1",align:"center",formatter:function(value,row,index){
                        return changeDataDictByKey("dc_eqStatus",value);
                }},
                {title: "10306状态", field: "eqStatusA",align:"center",formatter:function(value,row,index){
                        return changeDataDictByKey("dc_eqStatus",value);
                }},
                {title: "10307状态", field: "eqStatusB",align:"center",formatter:function(value,row,index){
                        return changeDataDictByKey("dc_eqStatus",value);
                }},
                {title: "10308状态", field: "eqStatusC",align:"center",formatter:function(value,row,index){
                        return changeDataDictByKey("dc_eqStatus",value);
                }},
                {title: "10309状态", field: "eqStatusD",align:"center",formatter:function(value,row,index){
                        return changeDataDictByKey("dc_eqStatus",value);
                }},
                {title: "记录时间", field: "checkTime",align:"center",formatter:function(value,row,index){
