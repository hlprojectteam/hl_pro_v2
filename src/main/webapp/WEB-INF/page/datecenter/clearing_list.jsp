		...
		<form id="baseForm" method="post" name="baseForm" class="form-horizontal" action="" >
			<c:if test="${not empty menuCode}">
				...
				<div class="row"  style="margin-top: 10px;">
					...
					<label class="col-sm-2 control-label">通知处理部门</label>
					<div class="col-sm-2">
...
<script type="text/javascript">
    ...
    function on_export(){
        ...
        if(star == null || star == "" || end == null || end == ""){
            ...
            window.location.href = URLStr + "export?dutyDateStart="+$("#dutyDateStart").val()+"&dutyDateEnd="+$("#dutyDateEnd").val()+"&keyword="+$("#keyword").val()+"&reportedDp="+$("#reportedDp").val()+"&reportedWay="+$("#reportedWay").val()
        }
    }
</script>
</body>
