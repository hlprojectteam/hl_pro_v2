...
var zTreeObj;
var educationVo_id = '${educationVo.id}';//记录ID
...
function loadPieReport(orgFrameID){
	$.ajax({
		...
		dataType : "text",
		contentType:"application/x-www-form-urlencoded",
		url: '/education/load_sonOrg_list?orgFrameID='+orgFrameID+'&educationVo_id='+educationVo_id,
...
function loadNodesPieReport(orgFrameID){
	$.ajax({
		...
		dataType : "text",
		contentType:"application/x-www-form-urlencoded",
		//url: '/education/pie?orgFrameID='+orgFrameID+'&educationVo_id='+educationVo_id,
		//url: '/education/load_sonOrg_list?orgFrameID='+orgFrameID+'&educationVo_id='+educationVo_id,
		url: '/education/click_tree_data?orgFrameID='+orgFrameID+'&educationVo_id='+educationVo_id,
		success : function(data){
					var count = eval("("+data+")");
					$("#rangeSelect").html("");
					$("#chooseUser").html("");
...
function firstTimeLoad(pId){
	...
	$.ajax({
		...
		async:false,
		dataType : "json",
		url: '/education/load_sonOrg_list?orgFrameID='+pId+'&educationVo_id='+educationVo_id,
		success : function(data){
			if(data!=null){
...
function getNodesReportUser(pId){
	...
	$.ajax({
		...
		async:false,
		dataType : "json",
//		url: '/education/nodes_user_list?orgFrameID='+pId+'&educationVo_id='+educationVo_id,
		url: '/education/click_tree_data?orgFrameID='+pId+'&educationVo_id='+educationVo_id,
		success : function(data){
			if(data!=null){
				 for (var i in data) {
...
function getNodesReportNotReadUser(pId){
	...
	$.ajax({
		...
		async:false,
		dataType : "json",
		//url: '/education/nodes_NotReaduser_list?orgFrameID='+pId+'&educationVo_id='+educationVo_id,
		url: '/education/click_tree_data?orgFrameID='+pId+'&educationVo_id='+educationVo_id,
		success : function(data){
			if(data!=null){
				 for (var i in data) {
